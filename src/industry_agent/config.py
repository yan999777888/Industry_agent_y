...
class Settings:
    ...
    models_dir: Path = Path(os.getenv("INDUSTRY_AGENT_MODELS_DIR", str(PROJECT_ROOT / "models"))).expanduser()
    ...
    llm_api_key: str = os.getenv("LLM_API_KEY", "tp-cwmpwum6b939t03f2l8tp994xtpbtwq2debv2o6p7r7imdkh")
