...
_TOPIC_RULES: tuple[TopicRule, ...] = (
    TopicRule(
        ...
        terms=("退货", "换货", "退换货", "退款"),
        overview="退换货和退款要结合订单状态、签收时间、商品是否使用以及平台规则综合判断。",
        materials="请先准备订单号、购买渠道、签收时间、商品当前状态，以及商品照片或开箱视频。",
        timeline="如果符合条件，退款到账时间还要看支付方式和平台审核进度，实际时效以原支付渠道处理结果为准。",
        fees="是否需要承担运费，取决于退换原因、商品是否存在质量问题以及平台售后规则。",
        eligibility="若商品未使用、仍在退换时效内，申请退货、换货或退款；是否最终通过仍要以售后审核为准。",
        process="请先在订单页发起售后申请，并同步说明问题原因、商品状态和诉求，必要时上传图片或视频证据。",
        contact="如果页面无法直接发起售后，请携带订单号和证据材料联系人工客服进一步处理。",
        scenarios=(
            ScenarioRule(
                name="size_exchange",
                terms=("更大", "更小", "大一号", "小一号", "换尺寸", "换尺码", "尺码", "尺寸差价", "补差价", "差价"),
                overview="如果是想把商品更换成更大或更小的尺寸，要先看是否仍在换货时效内、商品是否适合尺码更换，以及平台是否支持补差价处理。",
                materials="需要准备订单号、当前商品规格、想更换的目标尺寸、商品状态说明，以及外包装和配件是否完整的照片。",
                timeline="尺寸换货和差价处理时效取决于订单状态、换货审核、库存以及补差价流程。",
                fees="是否需要补差价、退差价或承担运费，要看新旧规格价格、换货原因以及平台规则；无质量问题时运费由买家承担。",
                eligibility="是否支持更换尺寸，取决于商品是否未明显使用、是否仍在换货时效内，以及目标尺寸是否有库存。",
                process="请先确认目标尺寸是否有库存，再在订单页发起换货申请并说明需要更换的规格；如涉及差价，按页面或客服指引补差或退差。",
                contact="如果页面没有尺寸换货入口或差价规则写得不清楚，请带上订单号联系人工客服核实。",
            ),
            ScenarioRule(
                name="refund_arrival",
                terms=("多久到账", "多久能到账", "原路返回", "信用卡", "银行卡", "储蓄卡", "借记卡", "退款多久"),
                overview="如果你主要关心退款到账，会先看支付渠道和退款是否已经审核通过，再判断到账时间。",
                materials="需要准备订单号、退款申请记录、支付方式、扣款账单或银行卡/信用卡账单截图。",
                timeline="退款到账时间取决于平台审核进度和支付渠道处理速度；信用卡、银行卡或第三方支付到账时效会不同。",
                fees="退款到账本身不以额外费用为核心，但是否有手续费或汇率差异，要看支付渠道规则。",
                eligibility="如果订单已成功取消或售后审核通过，才会进入正式退款流程。",
                process="请先确认订单是否已经取消成功或售后是否审核通过，再查看退款状态和原支付渠道回执。",
                contact="如果长时间未到账，请带上订单号和账单截图联系人工客服或支付渠道客服核查。",
            ),
            ScenarioRule(
                name="seven_day_no_reason",
                terms=("7天无理由", "七天无理由", "不想要了", "不喜欢", "不合适", "买错了"),
                overview="如果是未使用、配件齐全且仍在 7 天无理由范围内，更适合按无理由退货处理。",
                materials="需要订单号、签收时间，以及商品未使用、外包装和配件完整的说明或照片。",
                timeline="无理由退货的退款时效取决于退货寄回、仓库签收和平台审核进度。",
                fees="无质量问题的无理由退货，运费由买家承担；是否支持运费险抵扣要看平台规则。",
                eligibility="是否能走 7 天无理由，取决于商品类目、是否拆封使用以及是否仍在时效内。",
                process="请先在订单页选择无理由退货，并说明商品未使用、配件齐全的状态。",
                contact="如果页面提示该商品不支持无理由退货，请带上订单号联系人工客服核实类目限制。",
            ),
            ScenarioRule(
                name="quality_reason",
                terms=("质量问题", "有问题", "故障", "坏了", "破损", "瑕疵"),
                overview="如果退货诉求是因为质量问题，更适合按质量售后或故障退换处理，而不是普通无理由退货。",
                materials="需要准备故障照片、视频、异常描述以及签收时间，最好保留开箱证据。",
                timeline="质量问题的审核和退款时效会受售后判责、检测流程和退款路径影响。",
                fees="若经核实属于质量问题，运费和退换责任由商家或平台承担。",
                eligibility="是否支持直接退款或换货，取决于问题严重程度、签收时间和证据完整度。",
                process="请先提交质量问题售后申请，并尽量上传清晰的故障照片、视频或开箱记录。",
                contact="如果页面无法上传证据或判责有争议，请尽快联系人工客服升级处理。",
            ),
            ScenarioRule(
                name="opened_or_used",
                terms=("拆封", "开封", "使用过", "激活", "安装过", "试用过"),
                overview="如果商品已经拆封、激活或安装使用，更需要结合平台规则和售后审核判断是否还能退换。",
                materials="需要准备订单号、当前商品状态、拆封或使用情况说明，以及是否还能恢复完整包装的照片。",
                timeline="已拆封商品的审核时效取决于卖家判定和是否需要进一步检测。",
                fees="已拆封或已使用商品是否承担运费，更依赖具体类目规则和售后审核结果。",
                eligibility="是否还能退换，要看是否影响二次销售、是否存在质量问题以及平台规则。",
                process="请先如实说明拆封和使用情况，再提交售后申请，避免因信息不一致影响审核。",
                contact="如果你不确定当前状态是否还能退换，请带上订单号联系人工客服先做规则确认。",
            ),
            ScenarioRule(
                name="refund_rejected",
                terms=("驳回", "拒绝退款", "不通过", "审核失败", "没通过"),
                overview="如果退款或退货申请已经被驳回，需要先看驳回原因，再决定是补证据、改诉求还是升级申诉。",
                materials="需要准备订单号、售后单截图、驳回原因说明，以及商品当前状态、聊天记录或问题证据。",
                timeline="被驳回后的再次审核时效取决于补充材料是否完整以及平台工单处理进度。",
                fees="是否仍涉及运费或退款扣减，要结合驳回原因、商品状态和平台规则确认。",
                eligibility="是否还能重新提交，取决于驳回原因、是否仍在售后时效内以及是否有新的证据补充。",
                process="请先查看驳回原因；如果是材料不足，就补齐证据重新提交；如果你认为判定不合理，可发起申诉或联系客服升级。",
                contact="如果页面没有再次提交入口，请带上售后单截图联系人工客服复核。",
            ),
        ),
    ),
    TopicRule(
        ...
        overview="发票问题需要确认订单号、开票类型、抬头信息以及当前开票状态。",
        materials="请先准备订单号、开票类型、发票抬头、税号和接收邮箱等信息。",
        timeline="开票和补开发票的处理时效与订单状态、开票系统和平台规则有关，实际时间以平台处理进度为准。",
        fees="发票本身是否收费要看平台政策；如果涉及重开或邮寄，是否额外收费也要以平台规则为准。",
        eligibility="是否支持重开或修改抬头，取决于发票是否已开具以及平台是否允许更改。",
        process="请先确认订单是否满足开票条件，再提交或修改开票信息，必要时联系人工客服协助处理。",
        contact="如果你不确定发票状态，请携带订单号直接联系人工客服核实。",
        scenarios=(
            ScenarioRule(
                name="invoice_type",
                terms=("发票类型", "专票", "普票", "电子发票", "纸质发票"),
                overview="如果你想确认能开什么类型的发票，要先看订单开票入口支持的发票种类和商品类目限制。",
                materials="需要准备订单号、开票抬头、税号、邮箱，以及当前页面的开票选项截图。",
                timeline="发票开具时效取决于订单状态和开票系统处理进度。",
                fees="普通开票不以费用为核心；若涉及纸质邮寄或重开，是否收费要看平台规则。",
                eligibility="是否支持电子发票、普通发票或专用发票，要以订单开票入口和平台规则为准。",
                process="请先进入订单页查看可选发票类型；如果没有目标类型，再联系人工客服核实。",
                contact="如果你需要确认企业专票或纸质发票，请带上订单号和开票需求联系人工客服。",
            ),
            ScenarioRule(
                name="invoice_reissue",
                terms=("重开", "重开发票", "开错", "抬头填错", "税号错", "邮箱错"),
                overview="如果发票信息填错或已经开错，要先确认发票是否已开具、平台是否支持重开以及错误项属于哪一类。",
                materials="需要准备订单号、错误发票截图、正确的抬头/税号/邮箱信息，以及原申请记录。",
                timeline="发票重开的处理时效要看原发票状态、财务流程和平台规则，实际进度以系统审核为准。",
                fees="是否会产生邮寄费或重开成本，要结合平台规则和当前发票形态确认。",
                eligibility="是否支持重开，取决于发票是否已经开具、是否已报销以及平台是否允许修改该字段。",
                process="请先确认错误项属于抬头、税号还是邮箱；若支持修改或重开，尽快在订单页或客服渠道提交更正申请。",
                contact="如果你不确定当前发票是否还能重开，请带上订单号和错误发票截图联系人工客服核实。",
            ),
            ScenarioRule(
                name="invoice_after_issued",
                terms=("已经开票", "已开票", "开出来了", "开完了", "发票已出"),
                overview="如果发票已经开具，后续想修改抬头、税号或邮箱，不能按普通开票重新点选，而是要先看平台是否支持更正、红冲或重开。",
                materials="需要准备订单号、已开具发票截图、正确的抬头/税号/邮箱信息和当前修改诉求。",
                timeline="已开具发票的修改或重开时效取决于财务审核和平台发票流程。",
                fees="是否产生额外费用要看平台是否支持免费更正或重开，以及是否涉及邮寄。",
                eligibility="是否还能改，取决于发票是否已报销、是否已入账以及平台规则是否允许。",
                process="请先确认发票状态，再申请更正、红冲或重开；如果页面没有入口，直接联系人工客服核实。",
                contact="如果你已经收到开票完成通知，请一并提供发票截图给人工客服，方便快速判断还能怎么改。",
            ),
        ),
    ),
    TopicRule(
        ...
        overview="物流和配送问题需要结合订单号、物流单号、收货地址以及当前物流状态判断。",
        materials="请先准备订单号、物流单号、收货地址、异常时间点以及相关截图。",
        timeline="物流时效受仓库出库、承运商揽收和目的地配送能力影响，实际到达时间以物流轨迹为准。",
        fees="是否产生额外运费，要看配送地区、补发原因和物流方案，需结合订单系统进一步确认。",
        eligibility="乡镇、海外或特殊地区配送是否支持，要看平台覆盖范围和商品限制。",
        process="请先核对物流轨迹、签收状态和地址信息；若长期停滞、少件或误签，可尽快发起物流异常反馈。",
        contact="如物流长时间无更新或疑似丢件，请携带订单号和物流单号联系人工客服或承运商处理。",
        scenarios=(
            ScenarioRule(
                name="village_or_overseas",
                terms=("乡镇", "农村", "村里", "国外", "海外", "寄到国外", "国际", "偏远地区"),
                overview="如果你想确认乡镇、偏远地区或海外是否可配送，要先看商品是否支持该地区发货，以及末端配送能力是否覆盖。",
                materials="需要准备订单号、商品链接、详细收货地址或邮编，以及页面配送说明截图。",
                timeline="乡镇、偏远地区或海外配送时效会比普通城市地址更长，实际到达时间取决于仓库、承运商和目的地配送能力。",
                fees="是否需要额外运费，要看商品类目、配送地区和物流方案；偏远地区或海外产生附加费用。",
                eligibility="是否支持送达，取决于商品限制、地区覆盖和平台物流规则，不是所有商品都支持乡镇或海外直送。",
                process="请先在商品页或下单页核对配送范围；如果系统未明确显示，再联系人工客服确认详细地址是否可送达。",
                contact="如果你已经有完整地址或邮编，请一并提供给人工客服，这样直接核实。",
            ),
            ScenarioRule(
                name="tracking_stalled",
                terms=("没更新", "不更新", "没动", "停滞", "卡住", "未揽收", "一直没有物流"),
                overview="如果物流长时间没有更新，更像是揽收延迟、中转停滞或系统轨迹未同步的场景。",
                materials="需要准备订单号、物流单号、最近一次轨迹时间以及页面截图。",
                timeline="这类物流停滞的处理时效要看仓库、承运商反馈以及是否需要人工催查。",
                fees="物流停滞本身不是收费问题，重点是先确认是否超过承诺时效。",
                eligibility="是否能按异常物流处理，要对照最近轨迹时间和平台承诺时效判断。",
                process="请先核对最近一次轨迹更新时间；如果明显超时，可提交物流催查或人工催件。",
                contact="如果轨迹超过较长时间仍无变化，请同时联系人工客服和承运商催查。",
            ),
            ScenarioRule(
                name="package_lost_or_returned",
                terms=("丢件", "找不到", "退回", "被退回", "拒收", "错发", "异常轨迹", "运回"),
                overview="如果包裹出现丢件、退回、拒收或异常回流，要先按物流异常或包裹回查场景处理，而不是直接默认已完成配送。",
                materials="需要准备订单号、物流单号、最近轨迹截图、签收状态和收件地址信息。",
                timeline="丢件、退回或异常回流的核查时效要看承运商回查和仓库处理速度。",
                fees="这类问题是否涉及补发运费或退回费用，要看责任归属和平台规则。",
                eligibility="是否能按丢件或异常退回处理，要看轨迹是否完整、是否已签收以及承运商核查结果。",
                process="请先联系承运商确认包裹当前状态，再在平台提交物流异常或退回异常申请。",
                contact="如果物流显示退回但你并未发起退货，请尽快联系人工客服和承运商双向核实。",
            ),
            ScenarioRule(
                name="signed_but_missing",
                terms=("已签收", "显示签收", "代签", "没收到", "未收到"),
                overview="如果物流显示已签收但实际未收到，更像是代签、误投或末端配送异常场景。",
                materials="需要准备订单号、物流单号、签收时间、签收截图，以及门卫、驿站或家人是否代收的信息。",
                timeline="已签收未收到需要先核实末端签收情况，处理时效取决于承运商回查速度。",
                fees="这类问题不以费用为主，重点是先确认签收责任和包裹去向。",
                eligibility="是否可以按丢件或误签处理，要看签收记录、代签情况和回查结果。",
                process="请先联系承运商核实签收人，再同步在平台提交物流异常或未收到申请。",
                contact="如果承运商和平台说法不一致，请带上轨迹截图联系人工客服升级处理。",
            ),
            ScenarioRule(
                name="redirect_or_wrong_address",
                terms=("改派", "拦截", "送错", "发错地址", "派错", "改地址"),
                overview="如果是改派、拦截或送错地址，要先确认订单地址、物流状态以及末端站点是否支持改派。",
                materials="需要准备订单号、物流单号、原地址、新地址和当前轨迹截图。",
                timeline="地址改派或拦截的处理时效取决于包裹是否已进入末端配送以及承运商是否支持操作。",
                fees="是否收费要看改派距离、承运商政策和是否需要二次派送。",
                eligibility="是否还能改派，取决于包裹是否已签收、是否到站以及承运商规则。",
                process="请先联系承运商确认是否支持改派，再在平台侧同步更新或备注地址异常。",
                contact="如果系统侧和物流侧信息不一致，请携带订单号联系人工客服协调处理。",
            ),
        ),
    ),
    TopicRule(
        ...
        overview="投诉、假货、虚假宣传、二手商品或服务态度问题需要先固定证据再升级处理。",
        materials="需要准备订单记录、聊天记录、商品照片、视频以及页面宣传截图等证据。",
        timeline="投诉和升级处理的时效取决于平台工单流程和证据完整度，实际进度以平台反馈为准。",
        fees="投诉本身是否涉及额外费用不是重点，更重要的是先固定证据并确认赔付依据。",
        eligibility="是否支持赔偿或升级处理，要看证据是否充分以及平台判责结果。",
        process="请优先通过平台投诉单、售后工单或人工客服渠道提交证据并说明诉求。",
        contact="如果问题较严重，请直接联系人工客服并走官方投诉流程。",
    ),
    TopicRule(
        topic="after_sales",
        terms=("售后", "维修", "保修", "保修卡", "保障卡", "维修费用", "终身维修", "维修政策"),
        overview="售后、维修和保修问题需要确认商品型号、故障现象、购买时间和保修凭证。",
        materials="需要准备订单号、商品型号、故障描述、故障照片或视频以及保修凭证。",
        timeline="维修和保修审核时效要看检测流程、备件情况和售后网点安排，实际时间以售后反馈为准。",
        fees="是否收费取决于是否人为损坏、是否在保修期内以及具体维修项目。",
        eligibility="若商品仍在保修期且非人为损坏，进入保修流程；最终结果仍以售后检测为准。",
        process="请先提交售后申请并说明故障现象，必要时配合寄修、检测或预约售后网点。",
        contact="如果你不确定是否在保修范围内，请携带凭证联系人工客服或官方售后确认。",
        scenarios=(
            ScenarioRule(
                name="in_warranty",
                terms=("在保", "保修期内", "没过保", "还在保修期"),
                overview="如果确认仍在保修期内，更适合先按保修检测流程推进。",
                materials="需要准备订单号、购买时间、保修凭证、型号信息和故障照片或视频。",
                timeline="在保维修的处理时效取决于检测排队、配件库存和网点安排。",
                fees="如果检测后确认为非人为损坏且仍在保修范围内，免维修费；运费是否减免仍要看政策。",
                eligibility="是否最终按保修处理，还要看故障原因、购买时间和检测结论是否一致。",
                process="请先提交保修申请，并在描述里明确购买时间、故障现象和是否仍在保修期内。",
                contact="如果你已经有保修凭证，请直接联系官方售后或人工客服加快核验。",
            ),
            ScenarioRule(
                name="out_of_warranty",
                terms=("过保", "超出保修期", "保修过了", "过了保修期"),
                overview="如果已经过保，进入收费维修或付费检测流程，而不是标准保修。",
                materials="需要准备订单号、商品型号、购买时间和当前故障情况说明。",
                timeline="过保维修的处理时效取决于检测、报价确认和备件供应情况。",
                fees="过保后产生检测费、维修费或配件费，具体仍要以售后报价为准。",
                eligibility="是否还能获得免费处理，只有在特殊活动、延保或明确质量责任场景下才更有。",
                process="请先咨询售后是否支持付费检测，再确认报价和是否值得维修。",
                contact="如果你拿不准是否真的过保，请带上订单号和购买时间联系人工客服先核验。",
            ),
            ScenarioRule(
                name="human_damage",
                terms=("人为", "进水", "摔坏", "磕碰", "私拆", "外力"),
                overview="如果故障涉及进水、摔落、磕碰或私拆，更像是人为损坏场景，会影响是否能走保修。",
                materials="需要准备故障照片、受损部位说明、购买时间和当前是否还能开机的情况。",
                timeline="人为损坏的处理时效取决于检测、责任认定和维修报价确认。",
                fees="如果最终判定为人为损坏，产生检测费或维修费。",
                eligibility="这类情况是否还能免费保修，要以售后检测和品牌规则为准，很多场景下进入付费维修。",
                process="请先提交检测或维修申请，并如实说明进水、跌落或私拆等情况，避免后续判责反复。",
                contact="如果你担心被误判，请在寄修前带上照片和订单号联系人工客服或官方售后做预判。",
            ),
            ScenarioRule(
                name="repair_delay_or_repeat_failure",
                terms=("半个月", "一直没修好", "还没修好", "返修后", "又坏了", "同样的故障", "维修不彻底", "久修未好"),
                overview="如果维修时间明显过长，或维修后短时间内再次出现同样故障，要先按维修进度异常或返修复发场景升级核查。",
                materials="需要准备订单号、维修单号、送修时间、故障复发说明，以及维修前后照片、视频或聊天记录。",
                timeline="维修延期或返修复发的处理时效取决于售后网点反馈、复检安排和备件情况；如果需要重新返修，周期重新计算。",
                fees="如果确认是上次维修不彻底或返修复发，更适合优先核实是否应免费复检、免费返修或延长维修保障。",
                eligibility="是否支持优先处理、免费复检或延长保障，取决于维修记录、故障一致性和售后复核结果。",
                process="请先提供维修单号和送修时间，要求售后核实当前维修进度；如果是返修后短时间内同故障复发，可明确说明希望走复检或重新返修流程。",
                contact="如果网点反馈不清晰或长时间没有结果，请带上维修单截图联系人工客服或官方售后升级协调。",
            ),
            ScenarioRule(
                name="rejected_or_disputed",
                terms=("驳回", "拒绝", "不通过", "判定不合理", "想申诉", "复核", "重新审核", "证据不足"),
                overview="如果售后申请被驳回或你认为判定不合理，要先看驳回原因，再决定是补证据、申诉还是升级人工复核。",
                materials="需要准备订单号、售后单号、驳回截图、故障证据、聊天记录和你希望达到的处理诉求。",
                timeline="驳回后的再次审核或复核时效取决于补充材料是否完整以及平台工单处理速度。",
                fees="复核本身不涉及额外费用，但后续是否产生检测费、维修费或运费，要看最终判责结果。",
                eligibility="是否还能重新申诉，取决于是否仍在售后时效内，以及是否能补充更充分的证据。",
                process="请先明确驳回原因；如果是证据不足，就补充照片、视频或聊天记录后重新提交；如果判定有争议，可直接申请人工复核。",
                contact="如果平台没有明显的复核入口，请带上售后截图联系人工客服说明你希望重新审核的理由。",
            ),
        ),
    ),
    TopicRule(
        ...
        overview="破损、瑕疵、少件或保质期异常这类问题，需要尽快留证并核对签收时间。",
        materials="需要准备订单号、签收时间、问题照片、开箱视频以及异常细节说明。",
        timeline="若问题发生在签收后较短时间内，进入补发、换货或售后处理流程。",
        fees="是否产生额外费用要看问题原因和平台售后规则，质量问题更适合优先申请售后判责。",
        eligibility="是否支持补发、换货或退款，要看问题是否属于运输或质量异常，以及证据是否充分。",
        process="请先在订单页发起售后，并同步上传图片或视频说明问题。",
        contact="如系统无法提交售后，请直接联系人工客服升级处理。",
        scenarios=(
            ScenarioRule(
                name="packaging_damage",
                terms=("包装破损", "外包装破损", "包装损坏", "封条破损", "箱子破了"),
                overview="如果主要是外包装破损，先要区分是仅包装受损，还是已经影响到商品本体、配件或签收状态。",
                materials="需要准备订单号、签收时间、外包装照片、商品本体照片以及开箱视频。",
                timeline="包装破损类售后越早报备越容易核实，处理时效取决于售后审核和物流判责。",
                fees="如果最终判定为运输或质量问题，额外运费不应由买家单独承担；具体仍要看售后审核。",
                eligibility="仅外包装异常不一定直接影响退换货，但是否支持换货、退款或补偿，要看商品是否受损和证据是否充分。",
                process="请先拍照留证，再核对商品本体和配件是否完好；如有异常，尽快发起破损售后并上传证据。",
                contact="如果你担心影响退换，请带上签收时间和开箱证据联系人工客服先做判责。",
            ),
            ScenarioRule(
                name="missing_items",
                terms=("少发", "少件", "漏发", "缺件", "少了一件"),
                overview="如果收到后发现少发、漏发或缺件，可以先按缺件或补发场景申请售后核查。",
                materials="需要准备订单号、包装清单、缺件照片、开箱视频和签收时间。",
                timeline="缺件或少发的处理时效取决于售后审核、仓库核查和补发物流安排。",
                fees="若核实属于原包装缺失或漏发，补发费用不应由买家承担。",
                eligibility="是否支持补发、换货或退款，要看缺少的是主商品还是配件，以及证据是否充分。",
                process="请先对照包装清单确认缺少内容，再发起缺件/补发申请，并明确说明缺少的是哪一项。",
                contact="如果系统无法选择缺件类型，请带上包装清单和开箱证据联系人工客服处理。",
            ),
        ),
    ),
    TopicRule(
        ...
        overview="订单取消和退款到账问题取决于订单是否发货、支付方式以及平台规则。",
        materials="需要准备订单号、支付方式、支付时间和相关账单截图。",
        timeline="退款按原支付路径退回，到账时间受支付渠道和平台审核流程影响。",
        fees="是否产生手续费要看支付渠道和订单场景，具体仍要以支付渠道规则为准。",
        eligibility="如果订单尚未发货，申请取消；已发货订单则需要走拒收或售后流程。",
        process="请先确认订单状态，再在订单页提交取消或售后申请。",
        contact="若页面状态异常，请携带订单号联系人工客服核实。",
        scenarios=(
            ScenarioRule(
                name="refund_arrival",
                terms=("多久到账", "多久能到账", "原路返回", "信用卡", "退款多久"),
                overview="如果你主要关心退款到账，会按原支付路径退回；是否已经发起退款、以及支付渠道处理速度会直接影响到账时间。",
                materials="需要准备订单号、退款申请记录、支付方式、扣款账单或信用卡账单截图。",
                timeline="退款到账时间取决于平台审核进度和支付渠道处理速度；信用卡类支付也按原路径退回。",
                fees="退款到账本身不以额外费用为核心，但是否有手续费或汇率差异，要看支付渠道规则。",
                eligibility="如果订单已成功取消或售后审核通过，才会进入正式退款流程。",
                process="请先确认订单是否已经取消成功或售后是否审核通过，再查看退款状态和原支付渠道回执。",
                contact="如果长时间未到账，请带上订单号和账单截图联系人工客服或支付渠道客服核查。",
    ...
    TopicRule(
        ...
        overview="说明书补发或获取电子版需要先确认具体商品名称和型号。",
        materials="需要准备商品名称、型号、订单号以及需要的说明书版本。",
        timeline="电子版即时获取；纸质版是否支持补寄以及时效，要看包装配置和售后政策。",
        fees="纸质版补寄是否收费要以商品售后规则和客服核实结果为准。",
        eligibility="是否支持补寄纸质说明书，要看商品原始包装清单和品牌政策。",
        process="请优先通过商品页面、品牌官网或客服渠道获取电子版，再确认是否支持纸质补寄。",
        contact="如果页面找不到说明书入口，请携带型号联系人工客服。",
    ),
    TopicRule(
        topic="platform_service",
        terms=("以旧换新", "优惠券", "试用装", "试用", "智能客服", "人工客服", "活动规则", "会员", "优惠", "价格咨询"),
        overview="平台活动、优惠、试用和智能客服能力要以商品页面、活动规则和平台实际入口为准。",
        materials="需要准备商品名称、订单号、活动页面截图、优惠券信息或客服对话截图。",
        timeline="活动资格、优惠券使用和人工客服处理时效取决于平台规则和当前排队情况。",
        fees="是否产生费用或能否抵扣，要看活动规则、优惠券门槛和商品适用范围。",
        eligibility="是否支持以旧换新、试用装、优惠券或会员权益，取决于商品类目、活动时间和账号资格。",
        process="请先查看商品页、活动页或结算页是否有对应入口；如果没有入口，再联系人工客服核实。",
        contact="智能客服可处理常见订单、物流、售后和发票问题；需要人工核实时，请转人工并提供订单号和截图。",
        scenarios=(
            ScenarioRule(
                name="trade_in",
                terms=("以旧换新", "旧机", "回收"),
                overview="以旧换新取决于商品类目、旧机状态、活动入口和平台估价规则。",
                materials="需要准备新商品链接、旧机型号、成色说明、估价截图和订单信息。",
                timeline="以旧换新的处理时效取决于旧机评估、回收验机和补贴发放流程。",
                fees="是否有补贴、回收价或额外费用，要以活动页面和旧机检测结果为准。",
                eligibility="是否符合以旧换新资格，要看旧机品类、活动时间和账号/地区限制。",
                process="请先在商品页查看是否有以旧换新入口，再按页面要求填写旧机信息并确认估价。",
                contact="如果页面没有入口或估价异常，请联系人工客服核实活动资格。",
            ),
            ScenarioRule(
                name="coupon",
                terms=("优惠券", "优惠", "满减", "券", "折扣"),
                overview="优惠券能否使用取决于有效期、使用门槛、适用品类和是否可叠加。",
                materials="需要准备优惠券截图、商品链接、结算页截图和账号信息。",
                timeline="优惠券需要在有效期内使用，过期或活动结束后较难补用。",
                fees="优惠券本身不一定收费，重点是是否满足门槛以及是否能与其他活动叠加。",
                eligibility="是否适用所有商品，要以优惠券详情中的适用范围和排除规则为准。",
                process="请在结算页查看是否可勾选优惠券；若不可用，先核对有效期、门槛和适用品类。",
                contact="如果优惠券满足规则但无法使用，请带截图联系人工客服核实。",
            ),
            ScenarioRule(
                name="trial_sample",
                terms=("试用装", "试用", "样品"),
                overview="是否提供试用装或试用服务取决于商品活动、库存和平台规则。",
                materials="需要准备商品名称、活动页面截图和账号信息。",
                timeline="试用申请和发放时效以活动页面说明为准。",
                fees="试用是否收费、是否需要押金或运费，要以活动规则为准。",
                eligibility="是否能申请试用，取决于活动名额、账号资格和商品类目。",
                process="请先查看商品页或活动页是否有试用入口，再按页面要求提交申请。",
                contact="如果页面没有试用入口，请联系人工客服确认是否有相关活动。",
            ),
            ScenarioRule(
                name="trial_extension_or_fault",
                terms=("试用期", "试用期间", "延长试用", "延长试用期限", "试用故障", "试用期间故障"),
                overview="试用期间出现故障、想延长试用期限或确认能否换货时，要同时看活动规则、试用协议和故障责任判定。",
                materials="需要准备订单号、商品名称、活动页面或试用协议截图、故障照片/视频，以及试用开始时间和当前状态说明。",
                timeline="试用延期、故障审核或换货处理时效取决于活动规则、客服审核和售后判责进度。",
                fees="是否需要承担运费、押金或其他费用，要看试用活动规则、故障责任和换货方式。",
                eligibility="是否能延长试用或直接更换故障商品，取决于活动是否允许延期、商品是否仍在试用期内，以及故障是否属于非人为原因。",
                process="请先核对试用活动规则，再提交故障说明和延期/换货诉求；如果活动页没有自助入口，尽快联系人工客服登记并申请处理。",
                contact="如果同时涉及试用延期和故障换货，请一次性提供订单号、活动截图和故障证据给人工客服，避免重复沟通。",
            ),
            ScenarioRule(
                name="smart_customer_service",
                terms=("智能客服", "人工客服", "解答不了", "转人工"),
                overview="智能客服适合处理订单、物流、退换货、发票和售后等常见问题。",
                materials="如果要转人工，需要准备订单号、商品名称、问题截图和已尝试过的处理步骤。",
                timeline="人工客服响应时效取决于当前排队情况和问题复杂度。",
                fees="联系客服本身不是收费问题，重点是提供充分信息以减少来回沟通。",
                eligibility="需要订单核实、复杂判责或投诉升级的问题，更适合转人工处理。",
                process="请先让智能客服识别问题类型；如果无法解决，再选择转人工并一次性提供关键信息。",
                contact="转人工后请直接说明诉求、订单号、异常现象和期望处理方式。",
            ),
        ),
    ),
    TopicRule(
        ...
        overview="修改收货地址要先看订单是否已经发货或进入出库流程。",
        materials="需要准备订单号、当前订单状态和要修改的新地址。",
        timeline="如果订单还未出库，修改；若已发货，时效要看物流拦截或改派结果。",
        fees="是否产生额外费用要看改派方式、配送地区和平台规则。",
        eligibility="是否还能修改地址，取决于订单是否已出库、已发货以及物流是否支持改派。",
        process="请先确认订单状态；若仍可修改，尽快在订单页或客服渠道提交地址变更申请。",
        contact="若系统内无法直接改地址，请立即联系人工客服或物流方协助处理。",
        scenarios=(
            ScenarioRule(
                name="address_after_shipment",
                terms=("已经发货", "已发货", "出库了", "配送中", "快递已经发出"),
                overview="如果订单已经发货或进入配送中，修改地址不再是普通订单修改，而是要看物流是否支持拦截、改派或末端改址。",
                materials="需要准备订单号、物流单号、原地址、新地址和当前物流轨迹截图。",
                timeline="已发货后改地址的处理时效取决于包裹当前节点和承运商是否支持改派，越早处理越容易成功。",
                fees="已发货后改派是否收费，要看承运商规则、改派距离和是否需要二次派送。",
                eligibility="是否还能改地址，取决于是否已签收、是否进入末端配送，以及承运商是否允许改派。",
                process="请先联系承运商确认是否支持改派，同时在平台侧提交地址变更说明，避免订单侧和物流侧信息不一致。",
                contact="如果你这边已经有物流单号，请一并提供给人工客服或物流客服，这样更快确认是否能改派。",
            ),
        ),
    ),
    TopicRule(
        ...
        overview="预约安装或上门安装服务要结合订单状态、商品型号、安装地址和服务覆盖范围判断。",
        materials="需要准备订单号、商品型号、安装地址、联系电话和可预约时间。",
        timeline="预约安装时效受地区覆盖和师傅排期影响，最早可预约时间要以系统排期为准。",
        fees="是否收费要看商品是否含安装服务、所在地区以及安装项目范围。",
        eligibility="是否支持上门安装，要看商品类目、服务覆盖地区和订单状态。",
        process="请先确认订单是否支持安装服务，再提交预约申请并填写地址与时间。",
        contact="如系统内没有安装入口，请带上订单号联系人工客服确认。",
        scenarios=(
            ScenarioRule(
                name="installation_reschedule",
                terms=("改约", "改时间", "重新预约", "约不上", "师傅没来", "爽约", "改安装时间"),
                overview="如果已经预约安装但需要改约，或师傅未按约到场，要先确认原预约状态和最近可改约档期。",
                materials="需要准备订单号、预约时间、安装地址、联系电话，以及系统预约截图或师傅联系记录。",
                timeline="改约或重新排期的时效取决于地区覆盖、师傅排班和最近可预约时间段。",
                fees="是否产生额外费用，要看改约原因、是否多次爽约以及平台安装服务规则。",
                eligibility="是否支持改约，取决于服务单状态、地区排期和是否已经上门。",
                process="请先在安装服务单里查看是否支持改约；若系统无法修改，可联系平台或安装师傅重新确认时间。",
                contact="如果师傅爽约或多次改期，请带上服务单截图联系人工客服升级协调。",
            ),
        ),
    ),
    TopicRule(
        ...
        terms=("保价", "价保", "降价", "买贵了"),
        overview="价保或降价补差要结合订单时间、活动规则和平台价保政策判断。",
        materials="需要准备订单号、下单时间、当前商品页面价格截图以及活动页面信息。",
        timeline="是否在价保周期内是关键，具体审核时间仍要以平台处理进度为准。",
        fees="价保不是收费问题，关键在于是否满足平台补差规则。",
        eligibility="是否支持补差，取决于商品是否参加价保、下单时间是否在周期内以及活动是否适用。",
        process="请先核对商品页面的价保规则，再提交价保申请或联系人工客服核实。",
        contact="如果你不确定是否在价保周期内，请携带订单号和截图联系人工客服。",
    ),
    TopicRule(
        topic="payment_issue",
        terms=("支付失败", "付款失败", "扣款", "重复扣款", "支付异常", "扣了两次"),
        overview="支付异常问题需要先核对订单状态、支付流水和扣款时间。",
        materials="需要准备订单号、支付方式、扣款时间、银行或平台账单截图。",
        timeline="支付异常的处理时效取决于支付渠道回执、平台对账和财务核查进度。",
        fees="若涉及重复扣款或资金冻结，是否产生额外费用要以支付渠道处理结果为准。",
        eligibility="是否属于支付异常，要结合订单是否生成、是否重复扣款和账单记录综合判断。",
        process="请先确认订单是否生成，再核对支付流水；若账单异常，尽快联系客服发起核查。",
        contact="如资金问题较紧急，请同时联系平台客服和支付渠道客服处理。",
        scenarios=(
            ScenarioRule(
                name="repeat_charge",
                terms=("重复扣款", "扣了两次", "扣款两次", "多扣", "反复扣款", "重复支付"),
                overview="如果出现重复扣款，核心不是先重新下单，而是先核对是否生成了重复订单，以及两笔资金分别处于支付成功、冻结还是待退状态。",
                materials="需要准备订单号、支付流水号、两笔扣款账单截图、支付时间和支付方式信息。",
                timeline="重复扣款的核查时效取决于平台对账和支付渠道回执；如果一笔只是冻结款，解冻时间还要看银行或支付工具规则。",
                fees="是否会产生额外手续费要看支付渠道；多数情况下重点是确认哪一笔是有效支付、哪一笔需要退回或解冻。",
                eligibility="是否属于重复扣款，要结合订单数量、流水数量和账单状态综合判断，并不一定每次看到两笔记录都代表实际成功扣款两次。",
                process="请先确认是否生成了重复订单，再核对每笔流水状态；如果只有一笔订单却有两笔成功扣款，应尽快联系客服发起支付异常核查。",
                contact="如果资金占用比较紧急，请同时联系平台客服和支付渠道客服说明重复扣款情况。",
            ),
        ),
    ),
    TopicRule(
        ...
        overview="催发货和延迟发货问题要结合下单时间、库存状态和页面承诺时效判断。",
        materials="需要准备订单号、下单时间、商品页面承诺时效截图以及当前订单状态。",
        timeline="发货时间受库存、活动高峰和仓库排队影响，实际出库时间要以订单状态更新为准。",
        fees="是否涉及补偿或运费调整要以平台规则和实际延迟原因判断。",
        eligibility="是否属于异常延迟，要对照商品页面承诺时效和平台规则确认。",
        process="请先核对订单状态和承诺时效；若明显超时，可发起催发货或联系人工客服跟进。",
        contact="如果订单长时间未出库，请携带订单号联系人工客服催单。",
    ),
    TopicRule(
        topic="warranty_period",
        terms=("保修期", "质保期", "保修多久", "质保多久"),
        overview="保修期或质保期要结合商品类目、品牌规则、购买时间和保修凭证确认。",
        materials="需要准备商品名称、型号、下单时间和保修凭证。",
        timeline="保修期本身属于规则信息，是否还在有效期内要根据购买时间和官方规则核对。",
        fees="若超出保修期，涉及收费维修；具体费用仍要以售后检测结果为准。",
        eligibility="是否在保修范围内，取决于购买时间、故障类型和是否有人为损坏。",
        process="请先核对页面、保修卡或说明书中的保修规则，再确认当前是否还在期限内。",
        contact="如果你拿不准保修期起止时间，请带上订单号联系人工客服或官方售后核实。",
    ),
    TopicRule(
        topic="accessory_request",
        terms=("配件", "附件", "包装盒", "缺少配件", "少配件", "补寄配件"),
        overview="配件、附件、包装盒或补寄问题要先确认商品包装清单和实际缺少的内容。",
        materials="需要准备订单号、商品名称、缺少的具体配件名称以及开箱照片或视频。",
        timeline="补寄处理时效取决于售后审核、配件库存和物流安排。",
        fees="是否收费要看缺件原因、是否属于原包装缺失以及平台售后规则。",
        eligibility="是否支持补寄，要结合包装清单、问题责任和售后规则判断。",
        process="请先核对商品包装清单，再提交缺件或补寄申请，并说明缺少的具体部件。",
        contact="如页面无法提交补寄，请带上订单号联系人工客服处理。",
        scenarios=(
            ScenarioRule(
                name="accessory_rejected",
                terms=("补寄失败", "补件失败", "驳回", "拒绝补寄", "不给补寄", "审核不通过"),
                overview="如果补寄配件申请被驳回，要先看驳回原因，是包装清单不符、超出售后时效，还是证据不足。",
                materials="需要准备订单号、包装清单截图、缺少配件照片、开箱视频和售后单驳回截图。",
                timeline="补件驳回后的复核时效要看补充材料是否充分以及客服工单进度。",
                fees="若最终不支持免费补寄，是否能付费补购要看品牌配件供应和平台规则。",
                eligibility="是否还能重新申请，取决于是否仍在售后时效内，以及是否能补充更完整的缺件证据。",
                process="请先核对驳回原因；如果是证据不足，就补充开箱视频和包装清单后重新提交；如果是规则限制，可改为咨询付费补购。",
                contact="如果你认为包装内确实缺件但申请被拒，请带上包装清单和售后截图联系人工客服复核。",
            ),
        ),
    ),
)
